...
const App: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSubmitError(
        "An error occurred while transmitting your request. Please try again or contact me directly via LinkedIn.",
      );
    } finally {
  ...
  const getTechIcon = (category: string) => {
    switch (category) {
      case "Financial Administration":
        return <FileSpreadsheet className="w-5 h-5 text-emerald" />;
      case "Project Coordination":
        return <Workflow className="w-5 h-5 text-emerald" />;
      case "Information Security":
        return <Lock className="w-5 h-5 text-emerald" />;
      case "Global Partnerships":
        return <Globe2 className="w-5 h-5 text-emerald" />;
      default:
        return <Zap className="w-5 h-5 text-emerald" />;
    }
  };
  ...
  return (
    <div className="min-h-screen selection:bg-emerald selection:text-white bg-off-white font-body text-slate">
      ...
      <section
        id="hero"
        className="relative min-h-screen flex items-center bg-navy pt-24 pb-16 overflow-hidden"
      >
            ...
            <div className="animate-fade-in space-y-8 order-2 lg:order-1">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-3">
                  ...
                  <p className="text-emerald font-black text-[10px] uppercase tracking-[0.4em]">
                ...
                <h1 className="heading-font text-4xl md:text-5xl lg:text-6xl font-black uppercase leading-tight tracking-tight text-white max-w-xl">
                  Optimizing the <br />
                  Infrastructure of{" "}
                  <span className="text-emerald italic text-shadow-glow">
                    Success.
                  </span>
                </h1>
                ...
                <p className="text-lg md:text-xl text-white/50 font-light leading-relaxed max-w-lg">
                  ...
                  , managing the complexities of your business so you can focus
                  on scaling. From financial governance to global project
                  synchronization, I provide the foundation for excellence.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-6 items-center pt-2">
                <a
                  href="#experience"
                  className="group px-8 py-4 bg-emerald text-navy font-bold uppercase text-[10px] tracking-widest transition-all hover:bg-white hover:scale-105 active:scale-95 shadow-lg shadow-emerald/20 flex items-center gap-3"
                >
                ...
                <a
                  href="#contact"
                  className="text-white/40 hover:text-white transition-colors font-black uppercase text-[9px] tracking-[0.3em] flex items-center gap-3"
                >
                  Request Briefing{" "}
              ...
              <div className="pt-10 grid grid-cols-3 gap-6 border-t border-white/5 max-w-md">
                {[
                  ...
                  <div key={i} className="space-y-1">
                    <p className="text-[8px] font-black uppercase tracking-widest text-emerald/50">
                      {stat.label}
                    </p>
                    <p className="text-white/80 font-bold text-[11px] uppercase tracking-tight">
                      {stat.val}
                    </p>
                  </div>
                ))}
              ...
              <div className="relative group w-full max-w-sm">
                <div className="absolute -top-4 -left-4 z-20 bg-white p-4 shadow-xl border-l-4 border-emerald animate-float-slow hidden sm:block">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-black uppercase text-navy tracking-widest">
                      Accuracy Expert
                    </span>
                  </div>
                </div>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
          <span className="text-[7px] font-black uppercase tracking-[0.8em] text-white/20 animate-pulse">
            Scroll Down
          </span>
      ...
      >
        <div className="mb-20 grid lg:grid-cols-[1fr_auto_1fr] items-center gap-12">
          <p className="text-slate/60 text-lg md:text-xl font-light leading-relaxed max-w-xl">
            I concentrate on three strategic domains to ensure your operations
            are consistently{" "}
            <span className="text-navy font-semibold underline decoration-emerald/30 decoration-2 underline-offset-4">
              audit-resilient
            </span>{" "}
            and{" "}
            <span className="text-navy font-semibold underline decoration-emerald/30 decoration-2 underline-offset-4">
          ...
          <div className="flex gap-8 items-center">
            <div className="flex flex-col">
              <span className="text-emerald font-black text-3xl heading-font leading-none">
                03
              </span>
            ...
            <div className="flex flex-col">
              <span className="text-navy font-black text-3xl heading-font leading-none">
                High
              </span>
              <span className="text-[10px] font-black uppercase tracking-widest text-navy/30">
                Impact
        ...
        <div className="grid lg:grid-cols-3 gap-px bg-navy/5 border border-navy/5 shadow-sm">
          {CORE_VALUES.map((val, idx) => (
            <div
              key={idx}
              className="group relative bg-white p-10 lg:p-14 flex flex-col transition-all duration-500 hover:bg-off-white"
            >
              <div className="mb-10">
              ...
              <div className="pt-8 border-t border-navy/5">
                <div className="flex justify-between items-center text-[9px] font-black uppercase tracking-widest text-navy/30">
                  <span>Target</span>
                  <span className="text-navy font-black tracking-tight">
                    {val.outcome || "Peak Performance"}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-12 grid-rows-2 gap-6 h-auto lg:h-[600px]">
          ...
          <div className="lg:col-span-8 lg:row-span-2 group relative bg-white border border-navy/5 overflow-hidden flex flex-col shadow-sm transition-all duration-500 hover:shadow-2xl">
            ...
            <div className="p-10 lg:p-16 relative z-10 flex-1 flex flex-col">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h3 className="heading-font text-2xl lg:text-3xl font-black uppercase text-navy tracking-tight">
                    International NGOs
                  </h3>
                  <p className="text-emerald font-black text-[10px] uppercase tracking-[0.4em]">
                    Grant Compliance & Donor Relations
                  </p>
                </div>
              </div>
              <div className="max-w-2xl space-y-6">
                <p className="text-slate/60 text-lg font-light leading-relaxed">
                  I support global humanitarian missions by ensuring every donor
                  cent is accounted for. My trilingual capability enables
                  seamless correspondence between field offices and
                  headquarters.
                </p>
                <div className="grid md:grid-cols-2 gap-6 pt-6">
                  {[
                    {
                      label: "Fiscal Rigor",
                      desc: "Meticulous grant tracking for zero leakage.",
                    },
                    {
                      label: "Multilingual Support",
                      desc: "Liaison in English, French, and Swahili.",
                    },
                  ].map((feat, i) => (
                    <div key={i} className="flex gap-4">
                      <div className="shrink-0 w-1 h-full bg-emerald/20"></div>
                      <div>
                        <p className="text-[9px] font-black uppercase tracking-widest text-navy mb-1">
                          {feat.label}
                        </p>
                        <p className="text-slate/50 text-[11px] font-medium leading-tight">
                          {feat.desc}
                        </p>
                      </div>
                    </div>
          ...
          <div className="lg:col-span-4 lg:row-span-1 group relative bg-navy text-white p-10 flex flex-col justify-between overflow-hidden border border-white/5 transition-all duration-500 hover:bg-navy/95">
            ...
            <div>
              ...
              <h3 className="heading-font text-xl font-black uppercase tracking-tight mb-2">
                Tech Startups
              </h3>
              <p className="text-white/40 text-[9px] font-black uppercase tracking-widest mb-4">
                Systems Architecture
              </p>
              <p className="text-white/60 text-sm font-light leading-relaxed mb-6">
                Building the remote ops infrastructure that powers scaling
                companies.
              </p>
            </div>
          ...
          <div className="lg:col-span-4 lg:row-span-1 group relative bg-white p-10 flex flex-col justify-between overflow-hidden border border-navy/5 transition-all duration-500 hover:border-emerald/30">
            ...
            <div>
              ...
              <h3 className="heading-font text-xl font-black uppercase tracking-tight mb-2 text-navy">
                Construction
              </h3>
              <p className="text-emerald font-black text-[9px] uppercase tracking-widest mb-4">
                Field-to-Finance
              </p>
              <p className="text-slate/60 text-sm font-light leading-relaxed">
                Coordinating technical on-site ops with back-office accounting
                rigor.
              </p>
            </div>
              ...
              <div className="relative aspect-square max-w-[320px] mx-auto flex items-center justify-center border border-white/5 bg-white/[0.02] backdrop-blur-xl">
                ...
                <div className="flex flex-col items-center">
                  <div className="relative mb-8">
                    ...
                    <ShieldCheck
                      size={80}
                      className="text-emerald relative z-10 drop-shadow-[0_0_15px_rgba(16,185,129,0.5)]"
                    />
                  </div>
                  <div className="text-center space-y-1">
                    <div className="flex items-center gap-2 justify-center mb-2">
                      <div className="w-2 h-2 bg-emerald rounded-full animate-ping"></div>
                      <span className="text-[10px] font-black uppercase tracking-[0.3em] text-emerald">
                        System Secure
                      </span>
                    </div>
                    <p className="heading-font text-3xl font-black uppercase tracking-widest text-white leading-none">
                      100%
                    </p>
            ...
            <div className="lg:w-2/3 space-y-12">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-4 py-2 px-4 bg-emerald/5 border border-emerald/20">
                  ...
                  <span className="text-emerald font-black text-[10px] uppercase tracking-[0.4em]">
                    Audit-Ready Standard
                  </span>
                </div>
                <h3 className="heading-font text-4xl md:text-5xl lg:text-6xl font-black uppercase leading-tight tracking-tighter">
                  "I don't just organize files; <br /> I build{" "}
                  <span className="text-emerald italic">defense.</span>"
                </h3>
                <p className="text-white/50 text-xl font-light leading-relaxed max-w-2xl italic border-l-2 border-white/10 pl-8">
                  My systems ensure that whether it’s a tax review, a donor
                  audit, or a project post-mortem, every receipt, contract, and
                  communication is{" "}
                  <span className="text-white font-semibold">
                    100% verifiable
                  </span>{" "}
                ...
                {[
                  {
                    ...
                    desc: "Immutable proof for every corporate transaction.",
                  },
                  {
                    title: "Instant Retrieval",
                    icon: <CloudCog size={20} />,
                    desc: "High-speed cloud archival for rapid institutional recall.",
                  },
                  {
                    title: "Strategic Shield",
                    icon: <Shield size={20} />,
                    desc: "Pre-emptive risk management for institutional security.",
                  },
                ].map((point, idx) => (
                  <div
                    key={idx}
                    className="p-8 group hover:bg-white/[0.03] transition-all duration-300"
                  >
                    <div className="text-emerald mb-4 group-hover:scale-110 transition-transform origin-left">
                      {point.icon}
                    </div>
                    <h4 className="text-[10px] font-black uppercase tracking-widest text-white group-hover:text-emerald transition-colors mb-2">
                      {point.title}
                    </h4>
      ...
      <SectionWrapper
        ...
        dark
        className="py-32 overflow-visible"
      >
            ...
            {EXPERIENCE.map((exp, idx) => {
              ...
              return (
                <div key={idx} className="relative group">
                  ...
                  <div
                    className={`grid md:grid-cols-2 gap-8 md:gap-24 items-start ${isEven ? "" : "md:flex-row-reverse"}`}
                  >
                    <div
                      className={`${isEven ? "md:text-right" : "md:order-2 md:text-left"} pl-8 md:pl-0`}
                    >
                      ...
                      <h3 className="heading-font text-xl md:text-2xl font-black uppercase tracking-tight mb-2 text-white">
                        {exp.role}
                      </h3>
                      <p className="text-white/40 font-bold uppercase tracking-[0.2em] text-[11px] mb-6">
                        {exp.company}
                      </p>
                    </div>
                    <div
                    ...
                    >
                      <div className="space-y-4">
                        {exp.description.map((bullet, bIdx) => (
                          <div
                            key={bIdx}
                            className="relative pl-6 py-3 border-l border-white/5 hover:border-emerald transition-all duration-300"
                          >
        ...
        <div className="space-y-32">
          {CASE_STUDIES.map((study, idx) => {
            ...
            return (
              <div
                key={idx}
                className="relative group overflow-hidden border border-navy/5 shadow-sm"
              >
                <div
                ...
                >
                  ...
                  <div className="lg:w-1/2 p-10 md:p-14 bg-white flex flex-col justify-center">
                    <div className="mb-4">
                      <span className="text-[9px] font-black uppercase tracking-[0.3em] text-emerald">
                        {study.category}
                      </span>
                    </div>
                    ...
                    <div className="space-y-6 mb-10">
                      <div className="relative pl-4 border-l-2 border-emerald/20">
                        <p className="text-[8px] font-black uppercase tracking-widest text-emerald mb-1">
                          Challenge
                        </p>
                        <p className="text-slate/70 text-sm font-light leading-relaxed italic">
                          "{study.problem}"
                        </p>
                      </div>
                      <div className="relative pl-4 border-l-2 border-navy/10">
                        <p className="text-[8px] font-black uppercase tracking-widest text-navy mb-1">
                          Strategic Response
                        </p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {study.metrics.map((metric, mIdx) => (
                        <div
                          key={mIdx}
                          className="bg-navy p-10 flex flex-col justify-center items-center text-center border-b-8 border-emerald group-hover:translate-y-[-8px] transition-transform duration-500 shadow-xl shadow-navy/20"
                        >
                          <p className="text-white/40 text-[8px] font-black uppercase tracking-[0.4em] mb-4">
                            {metric.label}
                          </p>
                          <p className="text-5xl md:text-6xl font-black text-emerald heading-font leading-none tracking-tighter">
                            {metric.value}
                          </p>
                        </div>
                      ))}
                      <div
                        className={`${study.metrics.length === 1 ? "col-span-1" : "col-span-2"} bg-off-white p-8 border border-navy/5 flex items-center`}
                      >
                        <div className="flex-1">
                          <p className="text-navy/30 text-[8px] font-black uppercase tracking-[0.3em] mb-2">
      ...
      >
        <div className="mb-16 max-w-xl">
          <p className="text-slate/60 text-lg font-light leading-relaxed">
            I leverage enterprise-grade technologies to maintain the highest
            standards of financial integrity and project velocity.
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          {TECH_STACK.map((tech, idx) => (
            <div
              key={idx}
              className="bg-white p-8 flex flex-col border border-navy/5 hover:border-emerald transition-all duration-300 group"
            >
              <div className="mb-8">
              ...
              <div className="space-y-2 mb-8 flex-1">
                {tech.items.map((item, iIdx) => (
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-slate/80">
                      {item}
                    </span>
                  </div>
                ))}
          ...
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="lg:w-2/5 space-y-8">
              <div className="inline-flex items-center gap-3">
                ...
                <span className="text-emerald font-black text-[10px] uppercase tracking-[0.5em]">
                  Linguistic Edge
                </span>
              </div>
              ...
              <p className="text-white/40 text-lg font-light leading-relaxed max-w-sm">
                ...
                <span className="text-white font-medium">market access</span>. I
                act as your cultural and technical architect across three major
                global regions.
              </p>
              <div className="pt-8 grid grid-cols-2 gap-8 border-t border-white/5">
                <div>
                  <p className="text-emerald font-black text-2xl heading-font mb-1">
                    03
                  </p>
            ...
            <div className="lg:w-3/5 w-full space-y-4">
              {LANGUAGES.map((lang, idx) => (
                <div
                  key={idx}
                  className="group relative flex flex-col md:flex-row items-center gap-6 p-8 bg-white/[0.02] border border-white/5 transition-all duration-500 hover:bg-white/[0.04] hover:border-emerald/30 overflow-hidden"
                >
                  ...
                  <div className="flex-1 space-y-2 text-center md:text-left relative z-10">
                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
                      <h3 className="heading-font text-xl font-bold uppercase text-white tracking-tight">
                        {lang.name}
                      </h3>
                    ...
                    <div className="inline-flex items-center gap-2 mt-2 px-2 py-1 bg-emerald/10 border border-emerald/20 rounded-sm">
                      ...
                      <span className="text-[8px] font-black uppercase tracking-widest text-emerald">
                        {lang.geographicReach}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="shrink-0 md:w-48 pt-4 md:pt-0 border-t md:border-t-0 md:border-l border-white/5 md:pl-6 text-center md:text-left relative z-10">
                    <p className="text-[8px] font-black uppercase text-emerald/60 tracking-widest mb-1">
                      Strategic Utility
                    </p>
      ...
      <SectionWrapper
        ...
        className="bg-off-white py-48 overflow-hidden"
      >
          ...
          <div className="bg-navy p-10 lg:p-20 text-white relative">
            <div className="relative z-10">
              <h3 className="heading-font text-3xl font-black uppercase mb-8 tracking-tight leading-tight">
                Enhance your <br />{" "}
                <span className="text-emerald italic">
                  Operational Capacity.
                </span>
              </h3>
              <p className="text-white/50 text-base font-light leading-relaxed mb-12 max-w-xs">
                I am ready to integrate with your team. Specify your
                requirements and let's engineer a solution.
              </p>
                ...
                {[
                  {
                    icon: <Mail size={16} />,
                    label: "Email",
                    value: "mikemuganza@gmail.com",
                    href: "mailto:mikemuganza@gmail.com",
                  },
                  {
                    icon: <Linkedin size={16} />,
                    label: "Linkedin",
                    value: "@muganza-ainda-271a05275",
                    href: "https://www.linkedin.com/in/muganza-ainda-271a05275",
                  },
                  {
                    icon: <MapPin size={16} />,
                    label: "Base",
                    ...
                    <div>
                      ...
                      {item.href ? (
                        <a
                          ...
                          className="text-white text-sm font-bold tracking-tight hover:text-emerald transition-colors underline decoration-white/10 underline-offset-8"
                        >
                          {item.value}
                        </a>
                      ) : (
          ...
          <div className="p-10 lg:p-20 flex flex-col justify-center bg-white relative">
            {!isSubmitted ? (
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-10">
                  <div className="space-y-3">
                    <label className="text-[10px] font-black uppercase tracking-widest text-navy">
                      Professional Name
                    </label>
                    <input
                      required
                      name="user_name"
                      type="text"
                      className="w-full bg-off-white border-b-2 border-navy/5 py-4 px-5 text-sm text-navy focus:outline-none focus:border-emerald transition-all placeholder:text-navy/20"
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-widest text-navy">
                    Phone Number{" "}
                    <span className="text-navy/30 font-light lowercase">
                      (Optional)
                    </span>
                  </label>
                  <div className="relative">
                    ...
                    <input
                      name="user_phone"
                      type="tel"
                      className="w-full bg-off-white border-b-2 border-navy/5 py-4 pl-12 pr-5 text-sm text-navy focus:outline-none focus:border-emerald transition-all placeholder:text-navy/20"
                      placeholder="+256 ..."
                    />
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={4}
                    className="w-full bg-off-white border-b-2 border-navy/5 py-4 px-5 text-sm text-navy focus:outline-none focus:border-emerald transition-all resize-none placeholder:text-navy/20"
                    placeholder="Detail your project or support needs..."
                  ></textarea>
                </div>
              ...
              <div className="text-center py-20 animate-fade-in">
                ...
                <h3 className="heading-font text-3xl font-black uppercase text-navy mb-6 tracking-tight">
                  Transmission Successful.
                </h3>
                <p className="text-slate/60 text-base font-light leading-relaxed max-w-sm mx-auto mb-12">
                  Your inquiry has been successfully transmitted through the
                  secure channel. I will review the technical requirements and
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-1 space-y-6">
              <a href="#" className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white flex items-center justify-center text-navy font-black text-xl heading-font">
                  M
                </div>
                <span className="heading-font text-sm font-black text-white tracking-[0.2em] uppercase">
                  Muganza<span className="text-emerald italic">.</span>
                </span>
              </a>
              <p className="text-white/40 text-[11px] font-light leading-relaxed">
                Strategic operations architecture and financial governance for
              ...
              <div className="flex gap-4">
                {[
                  ...
                  <a
                    ...
                    className="w-8 h-8 border border-white/10 flex items-center justify-center text-white/30 hover:text-emerald hover:border-emerald transition-all group/icon"
                  >
                    {social.icon}
                  </a>
                ))}
            ...
            <div>
              <h4 className="heading-font text-[9px] font-black uppercase text-emerald tracking-widest mb-6">
                Expertise
              </h4>
              <ul className="space-y-3">
                {[
                  { name: "Operational Pillars", href: "#services" },
                  { name: "Impact History", href: "#experience" },
            ...
            <div className="bg-white/[0.03] p-6 border border-white/5">
              <h4 className="heading-font text-[9px] font-black uppercase text-white tracking-widest mb-4">
                Credentials
              </h4>
              <p className="text-white/40 text-[9px] font-medium leading-relaxed mb-6 uppercase tracking-widest">
                Access my full professional profile and trilingual dossier.
              </p>
              <a
                href={resumePdf}
              ...
              >
                <span
                  className={`transition-transform duration-300 ${downloadHovered ? "-translate-y-12" : "translate-y-0"}`}
                >
                  Download Briefing
                </span>
                <span
                  className={`absolute transition-transform duration-300 ${downloadHovered ? "translate-y-0" : "translate-y-12"}`}
                >
                  Get Technical Dossier
                </span>
          ...
          <div className="pt-12 border-t border-white/5 text-center md:text-left">
            <p className="text-white/10 text-[8px] font-black uppercase tracking-[0.5em]">
              Mike Muganza &copy; {new Date().getFullYear()} — Strategic
